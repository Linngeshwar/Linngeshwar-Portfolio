...
export default function ProjectCard({
  ...
  return (
    <motion.div
      className="project-card flex flex-col mx-16 p-8 bg-gradient-to-br from-neutral-900 to-neutral-950 border border-neutral-800 shadow-2xl rounded-2xl transition-all duration-300 hover:border-neutral-700 group"
    ...
    >
      ...
      {image && (
        <motion.div
          className="w-full h-48 mb-6 rounded-xl overflow-hidden bg-neutral-800 border border-neutral-700"
